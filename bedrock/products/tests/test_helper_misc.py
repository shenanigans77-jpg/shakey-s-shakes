...
class TestVPNMonthlyPrice(TestCase):
    ...
    def test_vpn_monthly_price(self):
        ...
        expected = (
            u'<span class="js-vpn-monthly-price-display" data-price-usd="TBD<span>/month</span>" '
            u'data-price-euro="9,99‎ €<span>/month</span>">TBD<span>/month</span></span>')
        self.assertEqual(markup, expected)
    ...
    def test_vpn_6_month_price(self):
        ...
        expected = (
            u'<span class="js-vpn-monthly-price-display" data-price-usd="TBD<span>/month</span>" '
            u'data-price-euro="6,99 €<span>/month</span>">TBD<span>/month</span></span>')
        self.assertEqual(markup, expected)
    ...
    def test_vpn_12_month_price(self):
        ...
        expected = (
            u'<span class="js-vpn-monthly-price-display" data-price-usd="TBD<span>/month</span>" '
            u'data-price-euro="4,99 €<span>/month</span>">TBD<span>/month</span></span>')
        self.assertEqual(markup, expected)
...
class TestVPNTotalPrice(TestCase):
    ...
    def test_vpn_6_month_total_price(self):
        ...
        markup = self._render(plan='6-month')
        expected = (
            u'<span class="js-vpn-total-price-display" data-price-usd="TBD total" '
            u'data-price-euro="41,94 € total">TBD total</span>')
        self.assertEqual(markup, expected)
    ...
    def test_vpn_12_month_total_price(self):
        ...
        expected = (
            u'<span class="js-vpn-total-price-display" data-price-usd="TBD total" '
            u'data-price-euro="59,88 € total">TBD total</span>')
        self.assertEqual(markup, expected)
